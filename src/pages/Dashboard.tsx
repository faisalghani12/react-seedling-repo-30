...
const Dashboard = () => {
  ...
  const tools = [
    ...
    },
    {
      ...
      description:
        "Calculate profits with break-even analysis and scenario planning",
      icon: TrendingUp,
      status: "available" as const,
      features: [
        "Break-even analysis",
    ...
    },
    {
      ...
      description:
        "Estimate business value using multiple proven valuation methods",
      icon: Building2,
      status: "available" as const,
      features: [
    ...
    },
    {
      ...
      description:
        "Multi-asset dashboard for tracking portfolio performance across all investments",
      icon: TrendingUp,
      status: "available" as const,
      features: [
