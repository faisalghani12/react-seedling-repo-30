        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-4xl mx-auto">
              From basic invoicing to advanced predictive analytics, our
              comprehensive suite covers every aspect of modern financial
              management.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 md:hidden">
            {financialSuite.slice(0, 4).map((tool, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="group border-0 shadow-card hover:shadow-elegant transition-all duration-300 overflow-hidden"
                >
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4 mb-4">
                      <div
                        className={`w-12 h-12 bg-${tool.gradient} rounded-lg flex items-center justify-center flex-shrink-0`}
                      >
          ...
          <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {financialSuite.map((tool, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="group border-0 shadow-card hover:shadow-premium transition-all duration-500 hover:-translate-y-2 overflow-hidden"
                >
                  <CardContent className="p-0">
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between mb-6">
                        <div
                          className={`w-14 h-14 bg-${tool.gradient} rounded-xl flex items-center justify-center`}
                        >
          ...
          <div className="text-center mt-12 md:mt-16">
            <Button
              ...
              className="shadow-elegant group px-6 md:px-8 py-3 md:py-4 w-full md:w-auto"
            >
