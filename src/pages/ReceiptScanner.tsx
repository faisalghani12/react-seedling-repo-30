      ...
      <div className="container mx-auto px-6 py-12 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Upload receipt images and extract data automatically using
            AI-powered OCR. Digitize your receipts, categorize expenses, and
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Advanced OCR technology extracts all text from receipt images with
              high accuracy
            </p>
          </div>
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Automatically categorize expenses and extract key information like
              totals and dates
            </p>
          </div>
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Export processed data to CSV, Excel, or integrate with your
              accounting software
            </p>
          </div>
        </div>
